...
export function Register(){
    ...
    async function handleRegister(e:FormEvent){
        ...
        try{
            ...
            console.log('Bulbasaur saiu da jaula', (await userCredential).user)
    ...
    return(
        ...
        <div className="flex w-full h-screen items-center justify-center flex-col">
            ...
            <Link to="/">   <h1 className="mt-11 text-amber-50 text-5xl font-bold  uppercase ">Crie  su<span className="bg-gradient-to-r from-yellow-500 to-orange-400 bg-clip-text text-transparent">a conta</span></h1></Link>
